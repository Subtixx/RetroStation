...
public:
    ...
    bool                operator==(const Transform4x4f& _other) const;
    bool                operator!=(const Transform4x4f& _other) const { return !(*this == _other); }

	inline       Vector4f& r0()       { return mR0; }
	inline       Vector4f& r1()       { return mR1; }
	inline       Vector4f& r2()       { return mR2; }
	inline       Vector4f& r3()       { return mR3; }
	[[nodiscard]] inline const Vector4f& r0() const { return mR0; }
	[[nodiscard]] inline const Vector4f& r1() const { return mR1; }
	[[nodiscard]] inline const Vector4f& r2() const { return mR2; }
	[[nodiscard]] inline const Vector4f& r3() const { return mR3; }
	...
	[[nodiscard]] inline const Vector3f& translation() const { return mR3.v3(); }
